...
//           <img className="rounded-2xl" src={photo} alt="Signup" />
//         </div>
  ...
  return (
    <section className="bg-[rgba(17,24,39)] min-h-screen flex items-center justify-center">
      <div className="bg-gray-100 flex rounded-2xl shadow-xl max-w-3xl p-5 items-center">
        ...
        <div className="md:w-1/2 px-8 md:px-16">
          <h2 className="font-bold text-2xl text-[rgba(17,24,39)]">Sign Up</h2>
          ...
          <form action="" className="flex flex-col gap-4" onSubmit={handleSubmit} >
            ...
            <button className="bg-[rgba(17,24,39,1)] rounded-xl font-bold text-white py-2 hover:scale-105 duration-300 hover:bg-gray-300 hover:text-[#302434]">
              Sign Up
            </button>
          </form>
