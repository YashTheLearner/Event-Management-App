...
export const Navbar = () => {
  ...
  <div className='flex items-center space-x-8'>
    <div className='text-[1.1rem] font-bold hover:text-[#ffcc00] text-[#EAEAEA] tracking-wide cursor-pointer'>
      <i className="fas fa-home"></i> HOME
    </div>

    <div className='text-[1.1rem] font-bold hover:text-[#ffcc00] text-[#EAEAEA] tracking-wider flex items-center space-x-2 cursor-pointer'>
      <svg xmlns="http://www.w3.org/2000/svg" className='bg-white rounded-full' width="35" height="35" viewBox="0 0 128 128">
    ...
    <button className="bg-yellow-500 hover:text-[#fff] hover:bg-yellow-600 text-black font-semibold py-2 px-4 rounded cursor-pointer" type="submit">Signup</button>
    <button className="bg-yellow-500 hover:text-[#fff] hover:bg-yellow-600 text-black font-semibold py-2 px-4 rounded cursor-pointer" type="submit">Login</button>
  </div>
</div>
    </>
  )
