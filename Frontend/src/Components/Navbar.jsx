    ...
    <>
      <div className='h-[60px] bg-[#1b263b] py-[8px] px-[96px] flex justify-between items-center'>
        ...
        <div className='flex items-center space-x-8'>
          ...
          <div className='text-[1.1rem] font-bold hover:text-[#ffcc00] text-[#EAEAEA] tracking-wider flex items-center space-x-2 cursor-pointer' onClick={()=>{navigate('/createEvent')}}>
